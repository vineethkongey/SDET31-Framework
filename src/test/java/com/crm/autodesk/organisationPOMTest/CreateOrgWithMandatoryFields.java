...
/**
 * This Test Script will create an organization with all the mandatory fields.
 * 
 * @author Soumyajit
 *
 */
@Listeners(com.crm.autodesk.commonutility.ListenerImplementationClass.class)
public class CreateOrgWithMandatoryFields extends BaseClass {
	...
	public void createOrgWithMandatoryFields() throws Throwable {
		 ...
		 */
		/*
		 * Log Out from Application homepage.signOut(driver); driver.quit();
		 */
	}
}
