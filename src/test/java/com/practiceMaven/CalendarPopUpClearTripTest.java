...
public class CalendarPopUpClearTripTest {
	public static void main(String[] args) throws Throwable {
		...
		//driver.findElement(By.xpath("//div[@class='row ml-2 p-relative w-100p']/descendant::button")).click();
		
//		for(;;)
//		{
//			try
//			{
//				driver.findElement(By.xpath("//div[text()='December 2022']/ancestor::div[@class = 'DayPicker-Months']/descendant::div[text()='10']")).click();
//				break;
//			}
//			catch(Exception e)
//			{
//				driver.findElement(By.xpath("//div[@class = 'flex-1 ta-right']/descendant::*")).click();
//			}
//		}
//		
